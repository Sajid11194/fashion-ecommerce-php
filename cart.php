            ...
            <div class="cart__item">
                <div class="d-flex">
                    ...
                    <div class="cart__item__features flex-grow-1">
                        ...
                        <form action="" method="post"><input type="text" name="remove_product" value="' . $index . '" hidden/><button class="cart__item__remove-btn" type="submit"><i class="lni lni-circle-minus"></i></button></form>
                        </div>
